...
export const PROVIDER_REQUIREMENTS: Record<string, ProviderRequirement> = {
  ...
  // OathNet v2 expansion — all gate on the same key (and share the 500/day pool).
  oathnet_stealer_search: { requiresKey: "OATHNET_API_KEY" },
  oathnet_victims_search: { requiresKey: "OATHNET_API_KEY" },
  oathnet_victim_manifest: { requiresKey: "OATHNET_API_KEY" },
  oathnet_victim_file: { requiresKey: "OATHNET_API_KEY" },
  oathnet_victim_archive: { requiresKey: "OATHNET_API_KEY" },
  oathnet_subdomains: { requiresKey: "OATHNET_API_KEY" },
  oathnet_breach_dbnames: { requiresKey: "OATHNET_API_KEY" },
  oathnet_ai_filter: { requiresKey: "OATHNET_API_KEY" },
  oathnet_scanner: { requiresKey: "OATHNET_API_KEY" },
  socialfetch_lookup: { requiresKey: "SOCIALFETCH_API_KEY" },
  socialfetch_web_read: { requiresKey: "SOCIALFETCH_API_KEY" },
  socialfetch_whoami: { requiresKey: "SOCIALFETCH_API_KEY" },
  socialfetch_balance: { requiresKey: "SOCIALFETCH_API_KEY" },
  ...
  // People Data Labs Person Enrichment — gated on PEOPLEDATALABS_API_KEY; keyless
