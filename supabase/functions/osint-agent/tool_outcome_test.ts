...
Deno.test("skipped: governance / budget / concurrency / dedup", () => {
  const skips = [
    ...
    "synapsint_lookup degraded this run — skipped",
    "5xx — provider 'synapsint_lookup' suppressed for investigation",
    "429 rate-limited — provider 'stolentax_footprint' suppressed for investigation",
    "selector blacklisted for synapsint_lookup",
