 ...
 *
 * They can differ when a later dedup/suppression gate rejects an admitted call;
 * reservations are intentionally permanent so the admission cap cannot reopen.
 */
