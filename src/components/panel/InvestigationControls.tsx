      ...
      <div className="flex items-center gap-1 ml-auto">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button size="sm" variant="ghost" className="h-7 gap-1 text-data text-muted-foreground hover:text-foreground">
        ...
        {status !== "active" ? (
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button
                size="sm"
                className="h-7 gap-1.5 text-eyebrow font-semibold uppercase tracking-[0.08em] bg-[hsl(var(--confidence-high))] text-[hsl(var(--surface-0))] hover:opacity-90 shadow-[0_0_18px_-4px_hsl(var(--confidence-high)/0.55)]"
              >
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="space-y-3">
                  ...
                  <span className="flex items-start gap-2 rounded-md border border-warning/40 bg-warning-muted px-2.5 py-2 text-data text-warning">
...
function SegBtn({
  ...
  return (
    <button
      onClick={onClick}
      className="px-2.5 h-6 inline-flex items-center gap-1.5 text-eyebrow font-medium uppercase tracking-[0.08em] text-muted-foreground rounded hover:bg-surface-3 hover:text-foreground transition-colors"
    >
