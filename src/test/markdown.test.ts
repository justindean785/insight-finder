...
describe("reflowCollapsedTables", () => {
  it("reflows a one-line collapsed findings table into proper rows", () => {
    ...
    const collapsed =
      "| Artifact | Label | Confidence | Source ||---|---|---|---|| mafiosofoe@gmail.com | CONFIRMED | 85 | 4-source breach |" +
    ...
    expect(lines[1]).toBe("| --- | --- | --- | --- |");
    expect(lines[2]).toBe("| mafiosofoe@gmail.com | CONFIRMED | 85 | 4-source breach |");
